...
You will work from the lab manual every day in class. As such, you will need to bring a copy of the lab manual (physical or electronic) with you to class every day. You should be able to download the Lab Manual from your course website (e.g., Canvas).



### TinkerPlots Data Sets

There are several data sets used in the lab manual, as well as in EPsy 3264 individual exams and group quizzes. You can download a ZIP file of these TinkerPlots data sets from your course website (e.g., Canvas). 
