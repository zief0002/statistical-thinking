...
Consider the research design of this study, published in the *New England Journal of Medicine*.^[Du Toit, G., et al. (2015). Randomized trial of peanut consumption in infants at risk for peanut allergy. *New England Journal of Medicine, 372*(9), 803&ndash;813.]
...
These findings suggest that high-risk children who consumed peanut products from infancy until they were 5 years old were significantly less likely to develop a peanut allergy than those who avoided peanuts, according to the LEAP randomized trial.
</div>
...
- The researchers found statistical evidence of a difference in rates of peanut allergies for children between 1997 and 2002. This difference was greater than would be expected because of chance if there was really no difference between rates in 1997 and 2002 (*p = .05*; borderline evidence against the null hypothesis).  
</div>
...
The degree of external validity evidence is also pretty low. Although telephone numbers were initially randomly sampled, many households did not respond. This wrecks the randomness. Also, many people in the U.S. do not have telephones, or are on a no-call list. This severly limits the generalizations.
</div>
