...
Much of the material presented in the lab manual requires the use of TinkerPlots&trade;. This software can be downloaded (for Mac or PC), and a license can be purchased from [http://www.tinkerplots.com/](http://www.tinkerplots.com/). If you have a Mac and are running a new version of the OS, download the [most recent beta version](ttp://www.tinkerplots.com/beta) of TinkerPlots3.
...
- [TinkerPlots 2 Data Files](https://github.com/zief0002/statistical-thinking/blob/master/tp2-data.zip?raw=true)
