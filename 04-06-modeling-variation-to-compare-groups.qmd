...
data.frame(
  ...
  variation = c("Experimental variation<br />(from assignment to groups)", "Experimental variation<br />(from assignment to groups)", "Sampling variation<br />(from selection from the population)", "Sampling variation<br />(from selection from the population)")
) |>
  gt() |>
