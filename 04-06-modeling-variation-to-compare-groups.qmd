...
data.frame(
  ...
  variation = c("Sampling variation<br />(from selection from the population)", "Experimental variation<br />(from assignment to groups)", "Sampling variation<br />(from selection from the population)", "Sampling variation<br />(from selection from the population)")
) |>
  gt() |>
